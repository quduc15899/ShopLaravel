				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li><a href="{{asset('/computer')}}">Computer</a></li>
							<li class="active">{{$computer_cate_name->cp_type}}</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="{{asset('/computer/chi-tiet/'.$lp->cp_slug)}}">{{$cp->cp_name}}</a></h3>
